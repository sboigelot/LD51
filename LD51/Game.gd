...
var valid_locations_per_product = {
	"res://Products/y30z130/Jip/Package.tscn" : 		[BARCODE_LOCATION.FRONT,BARCODE_LOCATION.LEFT,BARCODE_LOCATION.BOTTOM,BARCODE_LOCATION.RIGHT,BARCODE_LOCATION.TOP,BARCODE_LOCATION.BACK],
	"res://Products/z50/Poopalot/Package.tscn" : 		[BARCODE_LOCATION.FRONT,BARCODE_LOCATION.LEFT,BARCODE_LOCATION.BOTTOM,BARCODE_LOCATION.RIGHT,BARCODE_LOCATION.TOP,BARCODE_LOCATION.BACK],
	...
	"res://Products/y30z130/CaptainChris/Package.tscn": [BARCODE_LOCATION.FRONT,BARCODE_LOCATION.LEFT,BARCODE_LOCATION.BOTTOM,BARCODE_LOCATION.RIGHT,BARCODE_LOCATION.TOP,BARCODE_LOCATION.BACK],
	"res://Products/Cube/Fresch/Package.tscn": 			[BARCODE_LOCATION.FRONT,BARCODE_LOCATION.LEFT,BARCODE_LOCATION.BOTTOM,BARCODE_LOCATION.RIGHT,BARCODE_LOCATION.TOP,BARCODE_LOCATION.BACK],
